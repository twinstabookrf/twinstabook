...
<link href="resources/css/signUpForm2.css" rel="stylesheet" type="text/css">
<style>
	...
	<main>
		<form action="signUp.html" method="post" enctype="multipart/form-data" name="frm" onsubmit="return chk()">
			...
			<div class="logo">Twinstabook</div> 
				<div class="sign-form">
					<div id="zero">
						<span>아이디</span>&nbsp;&nbsp;<input type="text" id="id" name="member_id" placeholder="사용자 아이디">
					</div>
				...
				<div class="sign-form">
					<div id="one">
						<span>비밀번호</span>&nbsp;&nbsp;<input type="password" id="password" name="pwd" placeholder="영문,숫자,특수기호를 혼합하여 주세요."  required="required">
					</div>
				</div>
				<div class="sign-form">
				...
				<div class="sign-form">
					<div id="two">
						<span>닉네임</span>&nbsp;&nbsp;<input type="text" id="name" name="name" required="required">
					</div>
				</div>
				<div class="sign-form">
					<div id="three">
						<span>이메일</span>&nbsp;&nbsp;<input type="email" id="email" name="email" required="required">
					</div>
				</div>
				<div class="sign-form">
				<div id="four">
				...
				<div class="sign-form">
					<div class="update-form">
						<div id="five"><span>힌트 답변</span>&nbsp;&nbsp;<input type="text" id="answer" name="answer" placeholder="비밀번호 힌트 답변" required="required"></div>
					</div>
				</div>
